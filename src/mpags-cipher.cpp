...
int main(int argc, char* argv[])
{
  ...
  // initialize Caesar cipher class
  CaesarCipher caesar {settings.cipher_key};

  // Run the Caesar cipher (using the specified key and encrypt/decrypt flag) on the input text
  //std::string outputText { runCaesarCipher( inputText, caesar.key_, settings.encrypt ) }; // old method
  std::string outputText {caesar.applyCipher(inputText, mode)};
